...
//  ARPaint
//
//  Created by Matthew Clark on 08/11/2018.
...
class ViewController: UIViewController {
    ...
    private func setupHomeBtn() {
        ...
        self.homeBtn.setTitle(NSLocalizedString("home", comment: ""), for: .normal)
        self.homeBtn.titleLabel?.font = UIFont(name: PSFonts.psFontName, size: PSFonts.psBtnFontSize)
        self.homeBtn.setTitleColor(UIColor.PSSelectedBtnTxtColor, for: .normal)
        self.homeBtn.backgroundColor = UIColor.PSSelectedBtnBackgroundColor
    }
    ...
    @IBAction func homeBtnDidTapped(_ sender: UIButton) {
